...
Given("my fleet", function () {
    ...
    this.context = { user: user, repository: new InMemoryFleetRepository() };
...
Given("the fleet of another user", function () {
    ...
    this.context.otherFleetId = initializeFleetForUser(this.context.repository, otherUser);
});
Given("a vehicle", function () {
    this.context.vehicle = Vehicle.create(VehicleType.CAR);
});
Given("I have registered this vehicle into my fleet", function () {
    registerVehicleInFleet(this.context.repository, this.context.fleetId, this.context.user.id, this.context.vehicle);
});
Given("this vehicle has been registered into the other user's fleet", function () {
    registerVehicleInFleet(this.context.repository, this.context.otherFleetId, this.context.otherUser.id, this.context.vehicle);
});
...
Then("this vehicle should be part of my vehicle fleet", function () {
    var fleet = retrieveFleet(this.context.repository, this.context.fleetId);
...
Then("I should be informed that this vehicle has already been registered into my fleet", function () {
    ...
    var expectedMessage = "Vehicle with ID ".concat(this.context.vehicle.id, " is already registered in the fleet");
